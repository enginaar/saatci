...
$_['text_shipping_method']           = 'Siparişinizde kullanılacak kargo Türünü seçiniz.';
$_['text_payment_method']            = 'Siparişinizde kullanılacak ödeme Türünü seçiniz.';
...
$_['text_trial_description']         = '%s her %d %s(s) için %d Ödeme (ler) den sonra';
$_['text_payment_description']       = '%s her %d %s(s) için %d ödeme(ler)';
$_['text_payment_until_canceled_description'] = '%s her %d %s(s) İptal edilinceye kadar';
$_['text_day']                       = 'gün';
$_['text_week']                      = 'hafta';
...
$_['entry_fax']                      = 'Faks:';
$_['entry_address']                  = 'AdresSeçiniz';
$_['entry_company']                  = 'Şirket Adı:';
$_['entry_customer_group']           = 'Üyelik Türü:';
...
// Error
$_['error_warning']                  = 'Siparişiniz işlenirken bir sorun oluştu! Sorun devam ederse farklı bir ödeme türü seçip tekar deneyiniz ya da mağaza sahibi ile iletişime geçmek için <a href="%s">buraya tıklayınız</a>.';
$_['error_login']                    = 'Uyarı: E-Posta Adresi ve/ya da Şifreniz yanlış';
$_['error_approved']                = 'Dikkat: Giriş yapabilmeniz için üyeliğinizin onaylanması gerekir.';
...
$_['error_password']                 = 'Şifreniz 3 ile 20 karakter arasında olmalı!';
$_['error_confirm']                  = 'Şifreniz birbiriyle uyuşmuyor!';
...
$_['error_shipping']                 = 'Uyarı: Kargo türü gerekli!';
$_['error_no_shipping']              = 'Uyarı: Kargo türü mevcut değil. Lütfen <a href="%s">iletişim</a> için bize ulaşın!';
$_['error_payment']                  = 'Uyarı: Ödeme türü gerekli!';
$_['error_no_payment']               = 'Uyarı: Ödeme türü mevcut değil. Lütfen <a href="%s">iletişim</a> için bize ulaşın!';
$_['error_custom_field']             = '%s alanı gerekli!';