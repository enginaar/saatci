                                        ...
                                        <div class="item-inner">
                                            ...
                                            <div class="product-shop">
                                                <div class="f-fix">
                                                    ...
                                                    <div class="actions">
                                                        <button class="button btn-cart" onclick="cart.add('<?php echo $product['product_id']; ?>');" type="button" data-original-title="<?php echo $button_cart; ?>" rel="tooltip"><span><span><i class="fa fa fa-shopping-cart"></i></span></span></button>
