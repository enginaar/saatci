            ...
            <div class="main">
                <div class="col-main">
                    ...
                    <div class="account-create">
                        ...
                        <div class="pull-left"><a href="<?php echo $continue; ?>" class="button btn-proceed-checkout btn-checkout"><span><span><?php echo $button_shopping; ?></span></span></a></div>
                        <div class="pull-right"><a href="<?php echo $checkout; ?>" class="button btn-proceed-checkout btn-checkout"><span><span><?php echo $button_checkout; ?></span></span></a></div>
                        </div> 
