<form class="form-horizontal">
  ...
  <div class="buttons buttons-set">
      <button type="button" id="button-payment-address" data-loading-text="<?php echo $text_loading; ?>" class="btn button" ><span><span><?php echo $button_continue; ?></span></span></button>
  </div>
</form>
