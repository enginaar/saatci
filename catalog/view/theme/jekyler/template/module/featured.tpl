...
<div class="std">
    <div class="home-content">
        <div class="newproductslider">
            <div class="newproduct-title"><div class="bg-title"><h2 class="title"><?php echo $heading_title; ?></h2></div></div>		                                   
                ...
                <li class="item first item-animate" >
                    <div class="item-inner">
                        <div class="box-images">
                            ...
                            <a href="<?php echo $product['href']; ?>" title="<?php echo $product['name']; ?>" class="product-image">
                                <span >
                                    <img  width="195" height="195" src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>"> 
                                </span>
                            </a> 
                            <?php } ?>
                        </div>
...
<?php echo  html_entity_decode($wg24options['wg24themeoptionpanel_homemiddleshopinfobanners'][$wg24options['config_language_id']]);?>
<?php } ?>

<?php if($wg24options['wg24themeoptionpanel_homepage12']=="homepage3") {     ?>
<div class="col-sm-6">
    <div class="featuredproduct">
        <div class="bx-title featured-title"><h2><?php echo $heading_title; ?></h2></div>	
        <div class="slide-multirows">
           
                <?php $size3=count($products); $m=0; foreach ($products as $product) { ?>
                <?php if($m++%2==0):?>
                ...
                <li class="item first item-animate" >
                    <div class="item-inner">
                        <div class="box-images">
                            <?php if ($product['thumb']) { ?>
                            <a href="<?php echo $product['href']; ?>" title="<?php echo $product['name']; ?>" class="product-image">
                                    <img  width="170" height="170" src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>"> 
                            </a> 
                            <?php } ?>
                        </div>
                        <?php if ($product['price'] && $product['special']) { ?>
        ...
        pager: 0,
        maxSlides: 3,
        slideWidth: 170, 									//infiniteLoop: false,
        moveSlides:1,
        slideMargin: 30,
        autoHover: true, // stop while hover <=> slider.stopAuto(); + slider.startAuto();
        })
